    ...
    <div class="left-panel">
        ...
        <div id="avatar-wrap">
            ...
            <div class="hl-hotspot"
                 data-icon="🧠" data-title="Brain & HPA Axis"
            ...
            <div class="hl-hotspot"
                 data-icon="🦋" data-title="Thyroid Gland"
            ...
            <div class="hl-hotspot"
                 data-icon="❤️" data-title="Heart & Adrenal Health"
            ...
            <div class="hl-hotspot"
                 data-icon="💪" data-title="Muscle & Insulin Sensitivity"
            ...
            <div class="hl-hotspot"
                 data-icon="🩸" data-title="Hormone Blood Panel"
            ...
            <div class="hl-hotspot"
                 data-icon="🦠" data-title="Gut–Hormone Axis"
            ...
            <div class="hl-hotspot"
                 data-icon="🌸" data-title="Reproductive Hormones"
            ...
            <div class="hl-hotspot"
                 data-icon="⚡" data-title="Leg Muscles & Glucose"
    ...
    <div class="right-panel">
        <div class="login-box">
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-4">
                @csrf
                <div>
                    <label for="name" class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">Full name</label>
                    <input id="name" name="name" type="text" value="{{ old('name') }}" required autofocus
                           class="hl-input" placeholder="Jane Doe">
                </div>
                <div>
                ...
                <div>
                    ...
                    <div class="relative">
                        <input id="password" name="password" type="password" required
                               class="hl-input" placeholder="Min 8 characters" style="padding-right:44px;">
                ...
                <div>
                    <label for="password_confirmation" class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">Confirm password</label>
                    <div class="relative">
                        <input id="password_confirmation" name="password_confirmation" type="password" required
                               class="hl-input" placeholder="Re-enter password" style="padding-right:44px;">
                        <button type="button" id="togglePasswordConfirm"
                                onclick="(function(){
                                    var inp=document.getElementById('password_confirmation');
                                    var btn=document.getElementById('togglePasswordConfirm');
                                    if(inp.type==='password'){
                                        inp.type='text';
                                        btn.innerHTML='<svg xmlns=\'http://www.w3.org/2000/svg\' fill=\'none\' viewBox=\'0 0 24 24\' stroke-width=\'1.8\' stroke=\'currentColor\' class=\'w-5 h-5\'><path stroke-linecap=\'round\' stroke-linejoin=\'round\' d=\'M3.98 8.223A10.477 10.477 0 0 0 1.934 12C3.226 16.338 7.244 19.5 12 19.5c.993 0 1.953-.138 2.863-.395M6.228 6.228A10.451 10.451 0 0 1 12 4.5c4.756 0 8.773 3.162 10.065 7.498a10.522 10.522 0 0 1-4.293 5.774M6.228 6.228 3 3m3.228 3.228 3.65 3.65m7.894 7.894L21 21m-3.228-3.228-3.65-3.65m0 0a3 3 0 1 0-4.243-4.243m4.242 4.242L9.88 9.88\'/></svg>';
                                    } else {
