...
<div x-data="ragAdmin()" x-init="init()">
    ...
    {{-- Create form --}}
    <div x-show="showCreate" x-transition class="adm-card p-5 mb-5 adm-a" data-adm>
    ...
    <div x-show="!loading" class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <template x-for="(d, i) in docs" :key="d.id">
            <div class="adm-card p-5 group adm-a" :class="'adm-d' + Math.min(i, 5)" data-adm>
                <div class="flex items-start justify-between mb-3">
                    ...
                    <button @click="deleteDoc(d)" class="text-gray-300 hover:text-red-500 text-xs p-1 transition shrink-0" title="Delete">🗑️</button>
                </div>
    ...
    <div x-show="!loading && docs.length === 0" class="adm-card p-10 text-center adm-a adm-d0" data-adm>
